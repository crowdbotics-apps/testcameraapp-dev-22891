...
## Project Structure
    ...
    ├── testcameraapp_dev_22891  # Django project configurations
...
1. Clone this repo and `cd testcameraapp_dev_22891`
...
2. Clone this repo and `cd testcameraapp_dev_22891`
